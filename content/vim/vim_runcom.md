...
**註： 每個命令的設置都會讓該指令延緩執行以聽取是單按鍵輸入或是指令輸入，
...
_需安裝 [tmux](https://github.com/tmux/tmux)。_
...
set foldlevel=5         " method=indent
    ...
    nmap z/fmi :set foldmethod=indent
    " 手動摺疊
    nmap z/fmm :set foldmethod=manual
```
